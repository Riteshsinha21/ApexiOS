...
class ProfileVC: UIViewController,  UIImagePickerControllerDelegate  {
    ...
    @IBOutlet weak var privacyPolicyTxt: UITextField!
    
    
    
    @IBOutlet weak var termsAndConditionsTxt: UITextField!
    ...
    override func viewDidLoad() {
        ...
        privacyPolicyTxt.attributedPlaceholder = NSAttributedString(
                    string: "Privacy Policy",
                    attributes: [NSAttributedString.Key.foregroundColor: UIColor.black]
                )
        
        termsAndConditionsTxt.attributedPlaceholder = NSAttributedString(
...
//        self.tabBarController?.delegate = self
        ...
        self.privacyPolicyView.layer.cornerRadius = 20
        self.termsAndConditionsView.layer.cornerRadius =  20
...
//    }
    ...
    @IBAction func onClickPrivacyPolicy(_ sender: Any) {
        UIApplication.shared.open(URL(string: "https://apexmentalperformance.com/privacy-policy")! as URL , options: [:], completionHandler: nil)
    }
    
    
    
    @IBAction func onClickTermsAndConditions(_ sender: Any) {
        UIApplication.shared.open(URL(string: "https://apexmentalperformance.com/terms-and-conditions")! as URL , options: [:], completionHandler: nil)
    }
...
//            "user_name": userName!,
       ...
       // apiCall.callUrlSession(urlValue: "https://chawtechsolutions.co.in/dev/apex/api/delete_user.php", para: parameters as (AnyObject), isSuccess: true)
        apiCall.callUrlSession(urlValue: "https://apexmentalityapp.host/api/delete_user.php", para: parameters as (AnyObject), isSuccess: true)
        { (result) -> Void in
            0
