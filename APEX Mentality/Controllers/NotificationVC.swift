...
class NotificationVC: UIViewController , UITableViewDelegate , UITableViewDataSource {
    ...
    func clientAcceptApi()
    {
        ...
        let urlStr = "https://apexmentalityapp.host/api/client_approved_status.php"
    ...
    func clientRejectApi()
    {
        ...
        let urlStr = "https://apexmentalityapp.host/api/client_rejected_status.php"
        let parameters = ["user_id": userId]
        var urlRequest = URLRequest(url: URL(string: urlStr)!)
        urlRequest.httpMethod = "POST"
        do {
    ...
    func clientPendingApi()
    {
        ...
        let urlStr = "https://apexmentalityapp.host/api/client_pending_status.php"
        let parameters = ["user_id": userId]
        var urlRequest = URLRequest(url: URL(string: urlStr)!)
        urlRequest.httpMethod = "POST"
        do {
